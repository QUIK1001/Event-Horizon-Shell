...
def menu():
    ...
    from EHS.tools import ascii_arts, changelog, echo, shell_info, shutdown, timer, os_info, toggle_logs, toggle_theme, welcome, ping, password_gen, lines_of_code
    from EHS.theme_manager import apply_theme
    from EHS.tutorial import tutorial
    from EHS.constants import config
    from EHS.archiver import archiver
    from EHS.plugin_sys import plugin_system_menu
    print("Starting EHS...\n", end="")
    event_horizon()
    welcome()
