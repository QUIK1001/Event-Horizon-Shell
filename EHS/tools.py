...
def password_gen():
    ...
    import string
    from colorama import Fore, Style
    print(f"{Fore.CYAN}=== Password Generator ==={Style.RESET_ALL}")
...
def lines_of_code():
    from colorama import Fore, Style
    clear_screen()
    print(Fore.YELLOW + """main.py = 131 lines. 
EHS/:
    __init__.py = 35 lines.
    aliases.py = 54 lines.
    archiver.py = 404 lines.
    art.py = 63 lines.
    calc.py = 120 lines.
    chklib_clrscr.py = 90 lines.
    chkupd_speedtest.py = 155 lines.
    constants.py = 66 lines.
    editors.py = 106 lines.
    logger.py = 43 lines.
    plugin_sys.py = 160 lines.
    shell.py = 666 lines.
    theme_manager.py = 24 lines.
    tools.py = 392 lines.
    tutorial.py = 463 lines.
    weather.py = 66 lines.\n
    Project for 17 modules with 3,038 lines.""" + Style.RESET_ALL)
    input("Press Enter to continue...")
    clear_screen()
