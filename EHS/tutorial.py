...
def tutorial():
    ...
    try:
        while True:
            ...
            try:
                choice = input(Fore.LIGHTRED_EX + "Select tutorial (1-20) >> " + Style.RESET_ALL).strip()
                ...
                if choice == "1":
                    ...
                    def show_shell_tutorial():
                        ...
                        print("6.1.  • rmdir /all - Delete a directory and all its contents")
                        print("7. • time - Show current time")
                        print("8. • perf - System performance monitor")
                        print("9.  • dir - List directory contents")
                        print("10.  • cd - Change directory")
                        print("11.  • rmfile - Remove file")
                        print("12. • find - Search files/directories")
                        print("13. • alias - Manage command aliases")
                        print("14. • move - Move files/folders")
                        print("15. • copy - Copy files/folders")
                        print("16. • rename - Rename files/folders")
                        print("17. • grep - text search in files")
                        print("18. • wc - calculating text statistics")
                        print(Fore.GREEN + "\nExample usage:")
                    ...
                    while True:
                        ...
                        if shell_choice == "17":
                        ...
                        elif shell_choice == "6.1":
                            clear_screen()
                            print(text2art("rmdir /all"))
                            print(Fore.CYAN + "Command Tutorial" + Style.RESET_ALL)
                            print(Fore.YELLOW + "\nRemoves any directory")
                            print(Fore.GREEN + "\nEnter: rmdir /all->myfolder")
                            print("Output: Removes directory 'myfolder'")
                            ...
                            print(Fore.CYAN + "Command Tutorial" + Style.RESET_ALL)
                            print(Fore.YELLOW + "\nRemoves a file")
                            print(Fore.GREEN + "\nEnter: rmfile->main.exe")
                            print("Output: Deletes file 'main.exe'")
                            ...
                            print(Fore.GREEN + "\nEnter: find->main.exe")
                            print("Output: Finds all files/directories containing 'main.exe'")
                            ...
                            print(Fore.GREEN + "\nEnter: move->main.exe->C:\\")
                            print("Output: Moves main.exe to 'C:\\'")
                            ...
                            print(Fore.GREEN + "\nEnter: copy->main.exe->C:\\")
                            print("Output: Creates copy of main.exe in 'C:\\'")
                            ...
                            print(Fore.GREEN + "\nEnter: rename->main.exe->EHS")
                            print("Output: Renames file from 'main.exe' to 'EHS'")
                        
                        elif shell_choice == "17":
                            clear_screen()
                            print(text2art("grep"))
                            print(Fore.CYAN + "Command Tutorial" + Style.RESET_ALL)
                            print(Fore.YELLOW + "\nText search in files")
                            print(Fore.GREEN + "\nEnter: grep->QUIK->LICENSE->y->y")
                            print("Output: Shows all lines of the file that contain `QUIK`, with line numbers.")

                        elif shell_choice == "18":
                            clear_screen()
                            print(text2art("wc"))
                            print(Fore.CYAN + "Command Tutorial" + Style.RESET_ALL)
                            print(Fore.YELLOW + "\nCalculating text statistics")
                            print(Fore.GREEN + "\nEnter: wc->shell.py->*file statistic*")
                            print("Output: Shows the number of lines, words, characters,\n bytes, avg words/line, avg chars/line.")
                    ...
                    print(Fore.GREEN + "You already here" + Style.RESET_ALL)
                    continue
                    ...
                    clear_screen()
                    print(Fore.CYAN + "=== password generator Tutorial ===" + Style.RESET_ALL)
                    print(Fore.GREEN + "\nExample usage:")
                    print("1. Select option 16 from main menu")
                    print("2. Enter the password length.\n"
                    ...
                    clear_screen()
                    print(Fore.CYAN + "=== ZIP Archiver Tutorial ===" + Style.RESET_ALL)
                    print(Fore.YELLOW + "\nCreate and extract ZIP archives:")
                    print("  • Create archives from multiple files")
                    print("  • Extract archives to any directory")
                    print("  • View archive contents before extraction")
                    print(Fore.GREEN + "\nExample usage:")
                    print("1. Select option 17 from main menu")
                    print("2. Choose 'Create ZIP archive'")
                    print("3. Enter archive name (e.g., 'my_files.zip')")
                    print("4. Add files one by one")
                    print("5. Archive created with all selected files")

                elif choice == "18":
                    clear_screen()
                    print(Fore.CYAN + "=== Shutdown Tutorial ===" + Style.RESET_ALL)
                    print(Fore.GREEN + "\nExample usage:")
                    print("1. Select option 18 from main menu")
                    print("2. *shutdown animation*")
                    print("3. Exits to terminal")

                elif choice == "19":
                    clear_screen()
                    print(Fore.CYAN + "=== Plugin sys Tutorial ===" + Style.RESET_ALL)
                    print(Fore.GREEN + "\nExample usage:")
                    print("1. Select option 19 from main menu")
                    print("2. Plugin system automatically detects Python files:")
                    print("  • Create .py files in EHS directory")
                    print("  • File must contain main() function")
                    print("  • Excluded files: core system modules")
                    print("3. See the result")
                    ...
                    print(Fore.RED + "Invalid choice! Please select 1-20." + Style.RESET_ALL)
                    time.sleep(1)
                    clear_screen()
                    continue
